...
import in.insurance.props.AppProperties;
import in.insurance.constants.AppConstants;
...
public class PlanRestController {
	...
	public PlanRestController(PlanService planService, AppProperties appProps) {
		this.planService = planService; this.messages = appProps.getMessages(); }
